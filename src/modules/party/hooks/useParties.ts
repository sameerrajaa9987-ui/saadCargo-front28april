...
const crud = createResourceHooks<PartyListQuery, PartyCreatePayload, PartyListResult>(
  "parties",
  { list: listParties, create: createParty, update: updateParty, remove: deleteParty }
);
